...
<table class="table is-fullwidth" >
  <thead>
    <tr>
      ...
      $query = mysqli_query($connect,"SELECT barcode.kode_obat AS kode_obat,opname.kode_barcode AS kode_barcode,opname.status AS status,catatan,tanggal from opname INNER JOIN barcode where opname.kode_barcode = barcode.kode_barcode ORDER BY kode_barcode ASC"); // menampilkan data opname berdasarkan urutan kode obat 

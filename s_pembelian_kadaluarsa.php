...
if (!isset($_SESSION["login1"])) {
	...
	include "database/deb.php";
	$QuerySql = "SELECT *,harga_beli*jumlah_pasok AS total FROM `pasok`, `obat` WHERE pasok.kode_obat=obat.kode_obat ORDER BY pasok.tanggal_kadaluarsa ASC ";

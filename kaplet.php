<?php
//MOHAMMAD RIFKY FAJRI 
//1700018239
//E
//1. function kaplet ini untuk menampilkan data obat berdasarkan jenis nya yaitu jenis kaplet
	include 'db.php'; //untuk memasukan database nya 
	$QuerySql = "SELECT  * FROM obat  where jenis='Kaplet'"; //query yang digunakan untuk mensorting jenis obat kaplet

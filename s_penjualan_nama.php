...
if (!isset($_SESSION["login1"])) {
	...
	$QuerySql = "SELECT *,harga_obat*jumlah_terjual as total FROM `tabel_penjualan`, `obat` WHERE tabel_penjualan.kode_obat=obat.kode_obat ORDER BY obat.nama_obat ASC "; 	//buat memanggil fungsi query untuk mengurutkan table penjualan berdasarkan nama obat
...
<table class="table is-fullwidth" ><!--membuat table-->
  <thead>
    <tr>
      <th scope="col"><a href="s_penjualan_id.php"> ID PENJUALAN</a></th> 				<!--menampilkan navbar id penjualan -->
      <th scope="col"><a href="s_penjualan_tanggal.php">TANGGAL TERJUAL</a></th>		<!--menampilkan navbar tanggalterjual-->
      <th scope="col"><a href="s_penjualan_ko.php">KODE OBAT</a></th>					<!--menampilkan navbar kodeobat -->
      <th scope="col"><a href="s_penjualan_nama.php">NAMA OBAT</a></th>					<!--menampilkan navbar namaobat -->
      <th scope="col"><a href="s_penjualan_harga.php">HARGA OBAT</a></th>				<!--menampilkan navbar hargaobat -->
      <th scope="col"><a href="s_penjualan_jumlah.php">JUMLAH TERJUAL</a></th>			<!--menampilkan navbar jumlahterjual -->
      <th scope="col"><a href="s_penjualan_total.php">HARGA TOTAL</a></th>				<!--menampilkan navbar harga total -->
    </tr>
  </thead>
		<?php
			foreach ($SQL as $key) { 

...
if (!isset($_SESSION["login1"])) { // login
    	  header("location: http://localhost/apotik-keuangan/login.php");
      exit;
    }
	include "connection/db.php";
	$QuerySql = "SELECT *,harga_beli*jumlah_obat AS total FROM `supplier`, `obat` WHERE supplier.kode_obat=obat.kode_obat ORDER BY supplier.tanggal_beli ASC "; //menampilkan tabel harga beli dikalikan jumlah obat yang di beli dari suplier dan di order by tanggal

...
if (!isset($_SESSION["login1"])) {
  ...
  $QuerySql = "SELECT *,year(tanggal_pasok) as tahun,sum(jumlah_pasok) as jumlah_pasok,sum(harga_beli*jumlah_pasok) AS total FROM pasok group by year(tanggal_pasok) ASC";

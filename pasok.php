...
<table class="table is-fullwidth" >
  <thead>
    ...
    <?php
      ...
      foreach ($SQL as $key) {
        echo "<tr>
           <td bgcolor>$key[kode_pasok]</td>
           <td bgcolor>$key[kode_obat]</td>
           <td bgcolor>$key[kode_supplier]</td>
           <td bgcolor>$key[jumlah_pasok]</td>
           <td bgcolor>$key[harga_beli]</td>
           <td bgcolor>$key[tanggal_pasok]</td>
           <td bgcolor>$key[tanggal_kadaluarsa]</td>
        </tr>";

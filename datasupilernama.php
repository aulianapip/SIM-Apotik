...
<?php
	...
	$QuerySql = "SELECT * FROM `Supplier` ORDER BY `nama_pemasok` ASC";
        //queri untuk mengurutkan data supplier berdasarkan nama dari A-Z, jadi yang bagian atas adalah bagian nama supplier yang huruf awalnya A dan seterusnya sampe huruf Z

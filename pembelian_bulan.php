...
if (!isset($_SESSION["login1"])) {
  ...
  $QuerySql = "SELECT *,month(tanggal) as bulan,year(tanggal) as tahun,sum(jumlah) as jumlah_pasok,sum(harga*jumlah) AS total FROM jualbeli group by month(tanggal) ASC";

...
//1700018250
//E
//function obat pil dibuat agar memudahkan mencari semua obat pil yang ada di database

	include 'db.php';//untuk memasukan database gudang
	$QuerySql = "SELECT  * FROM obat  where jenis='Pil'";//query mencari data obat dengan jenis pil

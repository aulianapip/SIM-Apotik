<!--Siti Barkah Pellu 1700018235 (Menmbahkan dan memperbaiki fitur)-->
<!--OKZATUL REVANKA-->
...
if (!isset($_SESSION["login1"])) {//jika login gagal maka kembali login.php
	...
	$QuerySql = "SELECT *,harga_beli*jumlah_obat AS total FROM `supplier`, `obat` WHERE supplier.kode_obat=obat.kode_obat ORDER BY supplier.harga_beli ASC "; //menampilkan total harga_beli  dan jumlah_obat berdasarkan suplier

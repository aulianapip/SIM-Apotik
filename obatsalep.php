<?php
  include 'db.php';
  $QuerySql = "SELECT * FROM obat inner join jenis_obat on jenis_obat.kode_jenis=obat.kode_jenis where jenis_obat.nama_jenis='Salep'";
  $SQL = mysqli_query($connect, $QuerySql);
?>
<!--Gifari Nanda Utama membuat function sorting data obat salep-->

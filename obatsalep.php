...
//1700018250
//E
//function obat salep dibuat agar memudahkan mencari semua obat salep yang ada di database
	include 'db.php';//untuk memasukan database gudang
	$QuerySql = "SELECT  * FROM obat  where jenis='Salep'";//query mencari data obat dengan jenis obat salep

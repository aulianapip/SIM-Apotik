...
<head>
	<title>GRAFIK KEUNTUNGAN PENJUALAN BERDASARKAN TANGGAL</title>
...
?>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				labels: [<?php 
					$tanggal_jual= mysqli_query($koneksi, "SELECT Day(tgl_penjualan) as tanggal_jual FROM obat, penjualan_detail, pasok, penjualan WHERE obat.kode_obat=pasok.kode_obat and obat.kode_obat=penjualan_detail.kode_obat GROUP BY pasok.kode_obat");

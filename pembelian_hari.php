...
if (!isset($_SESSION["login1"])) {
  ...
  $QuerySql = "SELECT tanggal_pasok as tanggal,sum(jumlah_pasok) as jumlah_pasok,sum(harga_beli) as harga_beli,sum(harga_beli*jumlah_pasok) AS total FROM pasok group by day(tanggal_pasok)";
